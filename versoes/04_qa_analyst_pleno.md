# ARTHUR SANTOS NETO
**QA Analyst Pleno / SDET | Testes de Integração de APIs & Qualidade de Software | Background Dev C#**  
...
- Utilização intensiva de IA Generativa (**Google Antigravity e GitHub Copilot**) no ciclo completo de engenharia: implementação de funcionalidades, refatoração de código, prototipagem ágil e automação de testes unitários e de integração.
*Stack: React, Vite, Python, Chrome Extensions, Postman, C#, Google Antigravity, GitHub Copilot.*
...
- Automação da execução de testes em esteiras contínuas de CI/CD no TFS e Azure DevOps via scripts PowerShell.
- Planejamento e execução de testes de internacionalização (i18n) e testes de instaladores empresariais (.msi com WixSharp) com suporte a múltiplos idiomas (PT/EN/ES).
...
- **IA Generativa Aplicada a QA & Dev:** Google Antigravity, GitHub Copilot, Geração e Refatoração de Código, Testes Automatizados.
...
- **EF SET English Certificate:** 64/100 — C1 Proficient (Inglês Avançado para Negócios e Comunicação Global)
- **Português:** Nativo
